...
public class ImpressaoActibity extends Activity implements OnClickListener {
    /******************************************************************************************************/
    ...
    /******************************************************************************************************/
    // Debugging
    private static final String TAG = "ImpressaoActibity";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.button_scan: {
                Intent serverIntent = new Intent(ImpressaoActibity.this, DeviceListActivity.class);
            ...
            case R.id.Send_Button: {
                if (hexBox.isChecked()) {
                    ...
                    if (str.length() > 0) {
                        ...
                        Toast.makeText(ImpressaoActibity.this, getText(R.string.empty), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0) {
                            if (str.length() == 11 || str.length() == 12) {
                                ...
                                Toast.makeText(ImpressaoActibity.this, getText(R.string.msg_error), Toast.LENGTH_SHORT).show();
                                return;
                            }
                        } else if (which == 1) {
